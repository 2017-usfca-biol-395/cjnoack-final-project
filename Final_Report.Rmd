...
My hypothesis was that female cats would be more obese than male cats, especially after being neutered. However, the data indicates opposite results. It appears that there is no causation between getting neutered/spayed and weight gain. However, there appears to be a small, if not subtle, difference between male and female cats. Of course, this is heavily dependent on the bias of the previous experiment. 
