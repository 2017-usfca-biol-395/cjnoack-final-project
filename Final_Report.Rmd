...
After analyzing the abundance of different phenotypes by sex and the distribution of body masses, I wanted to look deeper into the body mass question. What were the mean body masses among the four phenotypes for both male and female cats? In Table 1, the phenotype with the highest mean body mass are the obese undergoing weight loss female cats, followed by obese male cats undergoing weight loss. The phenotype with the lowest mean body mass are the intact male cats, followed by intact females. The medians of body mass are obese male cats and neutered female cats.  
...
ggplot(data=melted_obj, 
  ...
  labs(title = "Grid plot",
       subtitle = "Abundance of male and female cats with different phenotypes",
       x = "Sex of Cat")
```
...
ggplot(aes(host_tot_mass_s, fill = host_phenotype_s)) +
  ...
  labs(title = "Density plot", 
       subtitle = "Distribution of body size in different phenotypes", 
