...
My hypothesis was that female cats are more obese than male cats, especially after being neutered. However, the data indicates opposite results. Male cats are heavier than female cats within all phenotypes; intact, neutered, obese, and obese with energy restriction. The findings are supported by supplementary studies indicating that male cats often gain weight after being neutered. Specifically, neutering male cats in the earlier stages (between weeks 3-10) or in the late stages (weeks 34-41) of sexual development can alter feeding behaviors [@allaway2016metabolic].
