...
meanage_10 %>%
  ggplot(aes(x = host_phenotype_s,
             ...
             fill = host_sex_s)) +
    geom_col(position = "dodge") +
  labs(title = "Male and female phenotypes measured to age",
       x = "Cat Phenotype",
       y = "Cat Age",
       fill = "Cat Sex")
```

**Figure 7**: A bar plot indicating different ages between the categories intact, neutered, obese, and obese after weight loss among females and males. We see females in all phenotypes have the largest range of age groups while males dominate the medium to young age groups. The intact and obese undergoing weight loss have similar patterns for males and females. The neutered and obese phenotypes show the strongest variance between the sexes. 
